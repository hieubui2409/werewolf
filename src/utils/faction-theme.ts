...
const FACTION_STYLES: Record<Faction | "dead", FactionStyle> = {
  villager: {
    ...
    textBright: "text-blue-600 dark:text-blue-300",
    badge: "bg-blue-700",
  ...
  wolf: {
    ...
    textBright: "text-red-600 dark:text-red-300",
    badge: "bg-red-700",
  ...
  third: {
    ...
    textBright: "text-purple-600 dark:text-purple-300",
    badge: "bg-purple-700",
  ...
  dead: {
    ...
    textBright: "text-red-700 dark:text-red-700",
    badge: "bg-red-900",
    shadow: "shadow-none",
