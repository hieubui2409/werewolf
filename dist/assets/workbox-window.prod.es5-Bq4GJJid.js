...
var p = (function (t) {
    ...
    return (
      ...
      (r.ln = function (e) {
        var t = r.fn,
          ...
          i = n.state,
          a = n === r.vn,
          o = { sw: n, isExternal: a, originalEvent: e };
        (!a && r.mn && (o.isUpdate = !0),
          r.dispatchEvent(new c(i, o)),
          i === `installed`
            ? (r.wn = self.setTimeout(function () {
                i === `installed` &&
                  t.waiting === n &&
                  r.dispatchEvent(new c(`waiting`, o));
              }, 200))
            : i === `activating` && (clearTimeout(r.wn), a || r.en.resolve(n)));
      }),
      (r.yn = function (e) {
        var t = r.hn,
  ...
  var a,
    u = t;
  (((a = r).prototype = Object.create(u.prototype)),
                ...
                l(r.bn(), function (e) {
                  ((r.fn = e),
                    r.dn &&
                      ...
                      r.en.resolve(r.dn),
                      r.on.resolve(r.dn),
                      r.dn.addEventListener(`statechange`, r.ln, {
                        once: !0,
                      })));
                  var t = r.fn.waiting;
                  return (
