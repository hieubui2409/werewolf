...
` +
    ...
    function Ro(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Er(o, e.memoizedState) && ((ic = !0), d && ((n = ga), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
...
`,
  ...
  le = (e, t, n) => {
    ...
    let i = O.getRegExp(`(${r.map((e) => (e === `?` ? `\\?` : e)).join(`|`)})`),
      a = !i.test(e);
    if (!a) {
      let t = e.indexOf(n);
  ...
  pe = class extends A {
    ...
    getResource(e, t, n, r = {}) {
      ...
      return (
        ...
        s || !a || !y(n) ? s : ue(this.data?.[e]?.[t], n, i)
      );
    }
...
var ve = (e) => !y(e) && typeof e != `boolean` && typeof e != `number`,
  ye = class e extends A {
    ...
    translate(t, n, r) {
      ...
      (typeof t == `function` && (t = _e(t, { ...this.options, ...i })),
        ...
        (t = t.map((e) =>
          typeof e == `function` ? _e(e, { ...this.options, ...i }) : String(e),
        )));
      let a =
      ...
      b && !m && S && (te = T);
      let E = ve(te),
        ne = Object.prototype.toString.apply(te);
      if (b && te && E && !_.includes(ne) && !(y(v) && Array.isArray(te))) {
    ...
    resolve(e, t = {}) {
      ...
      return (
        ...
        Array.isArray(e) &&
          (e = e.map((e) =>
            typeof e == `function` ? _e(e, { ...this.options, ...t }) : e,
          )),
        e.forEach((e) => {
  ...
  be = class {
    ...
    getScriptPartFromCode(e) {
      if (((e = de(e)), !e || !e.includes(`-`))) return null;
      let t = e.split(`-`);
    ...
    getLanguagePartFromCode(e) {
      if (((e = de(e)), !e || !e.includes(`-`))) return e;
      let t = e.split(`-`);
  ...
  xe = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  Se = {
    ...
    getSuffixes(e, t = {}) {
      ...
      return (
        ...
        n
          ? n
              .resolvedOptions()
              .pluralCategories.sort((e, t) => xe[e] - xe[t])
              .map(
                (e) =>
  ...
  we = (e, t, n, r = `.`, i = !0) => {
    let a = re(e, t, n);
    return (
      !a && i && y(n) && ((a = ue(e, n, r)), a === void 0 && (a = ue(t, n, r))),
      a
    );
  },
  Te = (e) => e.replace(/\$/g, `$$$$`),
  Ee = class {
    ...
    interpolate(e, t, n, r) {
      ...
      return (
        [
          { regex: this.regexpUnescape, safeValue: (e) => Te(e) },
          {
            regex: this.regexp,
  ...
  Le = class e extends A {
    ...
    init(e = {}, t) {
      ...
      let n = Ne();
      ((this.options = { ...n, ...this.options, ...Pe(e) }),
        (this.options.interpolation = {
          ...n.interpolation,
          ...this.options.interpolation,
        }),
      ...
      if (!this.options.isClone) {
        ...
        ((n.logger = k),
          ...
          (n.interpolator = new Ee(this.options)),
          (n.utils = {
            hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
          }),
          (n.backendConnector = new Me(
    ...
    getFixedT(e, t, n) {
      let r = (e, t, ...i) => {
        ...
        typeof a.keyPrefix == `function` && (a.keyPrefix = _e(a.keyPrefix, o));
    ...
    dir(e) {
      ...
      let t =
        ...
        n = this.services?.languageUtils || new be(Ne());
    ...
    cloneInstance(t = {}, n = Fe) {
      ...
      return (
        (a.translator = new ye(a.services, i)),
        a.translator.on(`*`, (e, ...t) => {
          a.emit(e, ...t);
        }),
        a.init(i, n),
...
var Re = (e, t, n, r) => {
  ...
  ze = {},
  Be = (e, t, n, r) => {
    (Ge(n) && ze[n]) || (Ge(n) && (ze[n] = new Date()), Re(e, t, n, r));
  },
  Ve = (e, t) => () => {
  ...
  st = {
    t: (e, t) => {
      if (Ge(t)) return t;
      if (Ke(t) && Ge(t.defaultValue)) return t.defaultValue;
...
var pt = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  mt = function (e, t) {
    ...
    if (n.domain) {
      if (!pt.test(n.domain)) throw TypeError(`option domain is invalid`);
      r += `; Domain=${n.domain}`;
    }
    if (n.path) {
      if (!pt.test(n.path)) throw TypeError(`option path is invalid`);
      r += `; Path=${n.path}`;
    }
    if (n.expires) {
  ...
  gt = {
    ...
    lookup(e) {
      ...
      if (t && typeof document < `u`) return ht.read(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      ...
      n && typeof document < `u` && ht.create(n, e, r, i, a);
    },
  },
  _t = {
    name: `querystring`,
  ...
  bt = () => {
    ...
    try {
      if (((yt = typeof window < `u` && window.localStorage !== null), !yt))
        return !1;
  ...
  xt = {
    ...
    lookup(e) {
      ...
      if (t && bt()) return window.localStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupLocalStorage: n } = t;
      n && bt() && window.localStorage.setItem(n, e);
    },
  },
  St = null,
  Ct = () => {
    ...
    try {
      if (((St = typeof window < `u` && window.sessionStorage !== null), !St))
        return !1;
      let e = `i18next.translate.boo`;
  ...
  wt = {
    ...
    lookup(e) {
      ...
      if (t && Ct()) return window.sessionStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupSessionStorage: n } = t;
      n && Ct() && window.sessionStorage.setItem(n, e);
    },
  },
  Tt = {
    name: `navigator`,
...
var jt = () => ({
  ...
  Mt = class {
    ...
    init() {
      ...
      ((this.services = e),
        (this.options = dt(t, this.options || {}, jt())),
...
var Nt = Le,
        ...
        ? (0, M.jsxs)(`div`, {
            ...
            children: [
              (0, M.jsx)(`h2`, {
                ...
                children: Nt.t(`common.systemError`, `Lỗi Hệ Thống`),
              }),
              !1,
              (0, M.jsx)(`p`, {
                className: `mb-4`,
              ...
              (0, M.jsx)(`button`, {
                ...
                children: Nt.t(`common.reloadPage`, `TẢI LẠI TRANG`),
              }),
            ],
          })
        : this.props.children;
  ...
  Yt = N(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
  Xt = N(`chevron-down`, [[`path`, { d: `m6 9 6 6 6-6`, key: `qrunsl` }]]),
  Zt = N(`chevron-up`, [[`path`, { d: `m18 15-6-6-6 6`, key: `153udz` }]]),
  Qt = N(`circle-plus`, [
...
var Nn = (e) => (t) => {
  ...
  Pn = (e, t) => (n, r, i) => {
    ...
    let m,
      h = () => {
        ...
        return Nn(u.getItem.bind(u))(a.name)
          .then((e) => {
            if (e)
  ...
  Bn = [...Fn, ...Rn, ...zn].map((e) => ({ ...e, version: e.version ?? 1 })),
  Vn = [
    `b_wolf`,
    `b_seer`,
    `b_guard`,
...
function Wn() {
  return [
    ...Vn.map((e) => Bn.find((t) => t.id === e)).filter((e) => e !== null),
  ]
    ...
    .map((e, t) => ({
      ...
      order: t + 1,
      faction: e.faction,
      abilities: e.abilities.map((e) => ({ ...e, id: `ab_${Hn()}` })),
    }));
}
function Gn(e, t) {
  return t > e.length
...
function qn(e, t) {
  let n = Math.max(0, ...e.map((e) => e.order)),
    r = {
      ...
      order: n + 1,
      faction: t.faction,
      abilities: t.abilities.map((e) => ({ ...e, id: `ab_${Hn()}` })),
    };
  return [...e, r];
}
function Jn(e, t, n) {
  let r = `c_${Hn()}`,
    ...
    o = {
      ...
      order: i + 1,
      faction: n.faction,
      abilities: n.abilities.map((e) => ({ ...e, id: `ab_${Hn()}` })),
    };
...
var P = jn()(
    Pn(
      (e) => ({
        ...
        addRoleFromTemplate: (t) => e((e) => ({ roles: qn(e.roles, t) })),
        createCustomRole: (t) =>
          e((e) => {
            let n = Jn(e.roleTemplates, e.roles, t);
        ...
        changeRoleOrder: (t, n) => e((e) => ({ roles: Yn(e.roles, t, n) })),
        deleteRole: (t) =>
          e((e) => ({
              ...
              e.id === t
                ? {
                    ...
                    abilities: [
                      ...
                      {
                        id: `ab_${Hn()}`,
                        name: Nt.t(`setup.defaultAbilityName`, `Ability`),
                        type: `nightly`,
                        max: 1,
                        targetCount: 1,
                      },
        ...
        executeAction: (t, n, r, i, a = !1) =>
          e((e) => {
            let o = e.roles.find((e) => e.id === i)?.faction ?? `villager`,
              s = Qn(e.players, e.actionLog, t, n, r, o, e.nightCount, a);
            return s.blocked
              ? e
        ...
        undoAction: (t) =>
          e((e) => {
            ...
            let i = $n(e.players, e.actionLog, t);
            ...
            return { ...i, redoStack: nr(e.redoStack, s) };
          }),
        redoAction: () =>
          e((e) => {
            let { entry: t, remaining: n } = rr(e.redoStack);
            return t
              ? {
      ...
      }),
      {
        ...
        onRehydrateStorage: () => (e, t) => {
          ...
          if (e) {
            let t = er(e.roleTemplates, Bn);
            P.setState({ roleTemplates: t });
          }
        },
        partialize: (e) => ({
          step: e.step,
  ...
  ar = (0, _.memo)(function ({ id: e, name: t, onNameChange: n }) {
...
function or() {
  let { t: e } = j(),
    t = P((e) => e.playerCount),
    n = P((e) => e.players),
    r = P((e) => e.handlePlayerCountChange),
    i = P((e) => e.updatePlayerName),
  ...
  return (0, M.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, M.jsx)(`div`, {
        ...
        children: n.map((e) =>
          (0, M.jsx)(ar, { id: e.id, name: e.name, onNameChange: a }, e.id),
        ),
      }),
    ],
  });
...
function lr() {
  let e = P((e) => e.players);
  return (0, _.useCallback)((t, n) => Zn(e, t, n), [e]);
}
function ur() {
  let e = P((e) => e.roles);
...
function pr(e) {
  return fr[e] ?? fr.villager;
}
function mr({ onOpenSelector: e }) {
  let { t } = j(),
    n = ur(),
    r = P((e) => e.updateRoleName),
    i = P((e) => e.deleteRole),
    a = P((e) => e.addAbility),
    o = P((e) => e.updateAbility),
    s = P((e) => e.deleteAbility);
  return (0, M.jsxs)(`div`, {
    className: `space-y-3`,
    children: [
      n.map((n) => {
                ...
                children: [
                  ...
                  n.abilities.length < 5 &&
                    (0, M.jsxs)(`button`, {
                      ...
                      children: [
                        (0, M.jsx)(fn, { size: 10, className: `mr-1 inline` }),
      ...
      ? (0, M.jsx)(`div`, {
          ...
          children: (0, M.jsxs)(`div`, {
            ...
            onTouchEnd: () => {
              ...
              ((h > hr || e > gr) && m(), g(0), y(!1), (b.current = null));
            },
            children: [
              o &&
                (0, M.jsx)(`div`, {
...
function yr({ isOpen: e, onClose: t, onCreateCustom: n }) {
  let { t: r } = j(),
    i = P((e) => e.roleTemplates),
    a = P((e) => e.roles),
    o = P((e) => e.addRoleFromTemplate),
    s = P((e) => e.deleteCustomTemplate),
    c = i.filter((e) => e.category === `custom`);
  return (0, M.jsxs)(_r, {
    isOpen: e,
    onClose: t,
    title: r(`setup.library`),
    icon: (0, M.jsx)(Jt, { size: 20 }),
    fullHeight: !0,
    children: [
      (0, M.jsxs)(`button`, {
        onClick: n,
        ...
        children: [
          (0, M.jsx)(Qt, { size: 16, className: `mr-2 inline` }),
          r(`setup.createCustomRole`),
        ],
      }),
      vr.map(({ category: e, faction: t, labelKey: n, color: s }) => {
...
function xr({ isOpen: e, onClose: t }) {
  let { t: n } = j(),
    r = P((e) => e.createCustomRole),
    i = P((e) => e.playerCount),
    a = P((e) => e.roles),
    [o, s] = (0, _.useState)(``),
    [c, l] = (0, _.useState)(`villager`),
    [u, d] = (0, _.useState)([
      { id: Hn(), name: ``, type: `nightly`, max: 1, targetCount: 1 },
    ]),
    [f, p] = (0, _.useState)([]),
    m = () => {
      let e = [];
    ...
    h = () => {
      ...
      (r({ name: o.trim(), faction: c, abilities: u }),
        s(``),
        l(`villager`),
        d([{ id: Hn(), name: ``, type: `nightly`, max: 1, targetCount: 1 }]),
        p([]),
        t());
    },
    g = () => {
    ...
    children: [
      f.length > 0 &&
        (0, M.jsx)(`div`, {
          ...
          children: f.map((e, t) => (0, M.jsx)(`p`, { children: e }, t)),
        }),
      (0, M.jsxs)(`div`, {
        className: `mb-4`,
        children: [
        ...
        children: [
          ...
          u.length < 5 &&
            (0, M.jsxs)(`button`, {
              ...
              children: [
                (0, M.jsx)(fn, { size: 12, className: `mr-1 inline` }),
      ...
      (0, M.jsxs)(`button`, {
        ...
        children: [
          (0, M.jsx)(Yt, { size: 16, className: `mr-2 inline` }),
          n(`common.save`),
        ],
      }),
    ],
...
function Cr({ isOpen: e, onClose: t }) {
  let { t: n, i18n: r } = j(),
    i = P((e) => e.cardViewMode),
    a = P((e) => e.timerSettings),
    o = P((e) => e.setCardViewMode),
    s = P((e) => e.setTimerSettings),
    c = P((e) => e.resetGame),
    [l, u] = (0, _.useState)(!1),
    d = (e) => {
      r.changeLanguage(e);
          ...
          children: [
            ...
            (0, M.jsx)(`button`, {
              ...
              children: (0, M.jsx)(`span`, {
                ...
                children: a.muted
                  ? (0, M.jsx)(Cn, { size: 12, className: `text-red-600` })
                  : (0, M.jsx)(Sn, { size: 12, className: `text-text-muted` }),
              }),
            }),
          ],
        }),
        ...
        (0, M.jsx)(`div`, {
          ...
          children: l
            ...
            : (0, M.jsxs)(`button`, {
                ...
                children: [
                  (0, M.jsx)(_n, { size: 16, className: `mr-2 inline` }),
...
function Tr() {
  let { t: e } = j(),
    ...
    n = P((e) => e.playerCount),
    r = P((e) => e.setStep),
    i = P((e) => e.changeRoleOrder),
    a = P((e) => e.updateAbility),
    [o, s] = (0, _.useState)(!1),
    [c, l] = (0, _.useState)(!1),
    [u, d] = (0, _.useState)(!1),
  ...
  return (0, M.jsxs)(`main`, {
    ...
    children: [
              ...
              (0, M.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, M.jsxs)(`button`, {
                    ...
                    children: [
                      (0, M.jsx)(Jt, { size: 12, className: `mr-1 inline` }),
                      e(`setup.library`),
                    ],
                  }),
                ],
              }),
              (0, M.jsx)(mr, { onOpenSelector: p }),
            ],
          }),
        ],
      }),
      (0, M.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, M.jsxs)(`button`, {
            ...
            children: [
              (0, M.jsx)(dn, { size: 16, className: `mr-2 inline` }),
              e(`setup.startGame`),
            ],
          }),
        ],
      ...
      (0, M.jsx)(xr, { isOpen: c, onClose: () => l(!1) }),
      (0, M.jsx)(Cr, { isOpen: u, onClose: () => d(!1) }),
      f &&
        (0, M.jsx)(wr, {
          selector: f,
          rolesCount: t.length,
...
function Fr() {
  ...
  return (
    ...
    (0, _.useEffect)(() => {
      (e.value <= 10 && e.value > 0 && e.active && Mr(`tick`),
        e.value === 0 &&
          e.initial > 0 &&
          !i.current &&
          ((i.current = !0), Mr(`bell`)));
...
var Ir = (0, _.memo)(function ({
  ...
  let { t: o } = j(),
    { timer: s, start: c, togglePause: l, stop: u } = Fr(),
    d = P((e) => e.timerSettings.muted),
    f = P((e) => e.setTimerSettings);
  return (
    (0, _.useEffect)(() => {
      if (!s.active) return;
      let e = (e) => {
                ...
                (0, M.jsxs)(`div`, {
                  ...
                  children: [
                    (0, M.jsxs)(`button`, {
                      ...
                      "aria-label": o(`game.history`),
                      children: [
                        (0, M.jsx)(Jt, { size: 20, className: `mb-0.5` }),
                        (0, M.jsx)(`span`, {
                    ...
                    (0, M.jsxs)(`button`, {
                      ...
                      "aria-label": o(`game.nextNight`),
                      children: [
                        (0, M.jsx)(ln, { size: 20, className: `mb-0.5` }),
                        (0, M.jsx)(`span`, {
                          className: `text-[8px] font-bold uppercase tracking-wider`,
                    ...
                    (0, M.jsxs)(`button`, {
                      ...
                      "aria-label": o(`settings.title`),
                      children: [
                        (0, M.jsx)(pn, { size: 20, className: `mb-0.5` }),
                        (0, M.jsx)(`span`, {
                          className: `text-[8px] font-bold uppercase tracking-wider`,
            ...
            (0, M.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, M.jsxs)(`button`, {
                  ...
                  children: [(0, M.jsx)(wn, { size: 14 }), o(`game.useSkill`)],
                }),
              ],
            }),
          ],
...
function Br() {
  return (0, M.jsx)(`div`, {
    ...
    children: (0, M.jsx)(mn, { size: 64, className: `text-red-900/30` }),
  });
}
var Vr = 2;
function Hr({ actions: e, onUndoAction: t, onOverflowClick: n }) {
  let { t: r } = j();
  if (e.length === 0) return null;
  let i = e.length > Vr;
  return (0, M.jsxs)(`div`, {
    ...
    children: [
      (0, M.jsx)(`div`, {
        ...
        children: e.map((e) => {
          let n = pr(e.faction),
            i = Lr(r, e.abilityNameKey, e.abilityName);
          return (0, M.jsxs)(
            `button`,
            {
              onClick: (n) => t(e.id, n),
              ...
              children: [
                ...
                (0, M.jsxs)(`span`, {
                  ...
                  children: [
                    e.abilityType === `limited` &&
                      (0, M.jsx)(sn, { size: 8, className: `opacity-70` }),
                    (0, M.jsx)(`span`, {
                ...
                (0, M.jsx)(Tn, { size: 10, className: `opacity-50` }),
              ],
            },
            e.id,
          );
      ...
      (0, M.jsxs)(`div`, {
        ...
        children: [
          e.slice(0, Vr).map((e, n) => {
            let a = pr(e.faction),
              o = Lr(r, e.abilityNameKey, e.abilityName),
              s = i && n === Vr - 1;
            return (0, M.jsxs)(
              `button`,
              {
...
function Ur({ ab: e, used: t, exhausted: n, role: r, onUseSkill: i }) {
  let { t: a } = j();
  return (0, M.jsxs)(`button`, {
    ...
    children: [
      (0, M.jsx)(`span`, {
        ...
        children: Lr(a, e.nameKey, e.name),
      }),
      (0, M.jsx)(`span`, {
        className: `bg-bg-elevated px-1 rounded`,
        children:
          e.type === `limited` ? `${t}/${e.max}` : (0, M.jsx)(ln, { size: 8 }),
      }),
    ],
  });
}
...
function Gr({ isOpen: e, onClose: t }) {
  let { t: n } = j(),
    r = ur(),
    i = P((e) => e.players),
    a = P((e) => e.togglePlayerRole),
    [o, s] = (0, _.useState)(null);
  return (0, M.jsx)(_r, {
    isOpen: e,
    onClose: t,
    title: n(`game.assignRole`),
    icon: (0, M.jsx)(en, { size: 20 }),
    fullHeight: !0,
    children: (0, M.jsx)(`div`, {
      className: `space-y-2`,
      children: r.map((e) => {
                  ...
                  (0, M.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, M.jsx)(`span`, {
                        ...
                        children: Lr(n, e.nameKey, e.name),
                      }),
                    ],
                  }),
                  (0, M.jsxs)(`div`, {
...
function qr({ isOpen: e, onClose: t, initialContext: n }) {
  let { t: r } = j(),
    i = ur(),
    a = P((e) => e.players),
    o = P((e) => e.actionLog),
    s = P((e) => e.executeAction),
    c = P((e) => e.undoAction),
    l = lr(),
    [u, d] = (0, _.useState)(Kr),
    [f, p] = (0, _.useState)(null),
          ...
          children: (0, M.jsxs)(`div`, {
            ...
            children: [
              (0, M.jsxs)(`div`, {
                ...
                children: [
                  (0, M.jsx)(vn, { size: 18, className: `text-amber-400` }),
                  (0, M.jsx)(`span`, {
              ...
              (0, M.jsx)(`p`, {
                ...
                children: r(`game.deadSourceConfirm`, {
                  name: m.sourceName,
                  ability: Lr(r, m.ability.nameKey, m.ability.name),
                  defaultValue: `${m.sourceName} đã chết. Vẫn thực hiện ${Lr(r, m.ability.nameKey, m.ability.name)}?`,
                }),
              }),
              (0, M.jsxs)(`div`, {
                className: `flex gap-3`,
                ...
                children: [
                  (0, M.jsxs)(`button`, {
                    ...
                    children: [
                      (0, M.jsx)(`span`, {
                        className: `font-bold ${t.textBright}`,
                        children: Lr(r, e.nameKey, e.name),
                      }),
                      (0, M.jsx)(`span`, {
                            ...
                            children: (0, M.jsxs)(`span`, {
                              ...
                              children: [
                                (0, M.jsx)(`span`, {
                                  ...
                                  children: Lr(r, t.nameKey, t.name),
                                }),
                                (0, M.jsxs)(`span`, {
        ...
        (0, M.jsxs)(`div`, {
          ...
          children: [
            (0, M.jsxs)(`button`, {
              ...
              children: [
                (0, M.jsx)(Kt, { size: 12, className: `mr-1 inline` }),
                ` `,
                r(`common.back`),
              ],
            }),
          ...
          children: [
            ...
            (0, M.jsxs)(`p`, {
              ...
              children: [
                ...
                ` `,
                (0, M.jsx)(`strong`, {
                  children: Lr(r, u.ability.nameKey, u.ability.name),
                }),
                ` `,
                `(`,
                u.targets.length,
...
function Jr({ playerId: e, onClose: t, onUseSkill: n }) {
  let { t: r } = j(),
    i = P((e) => e.players),
    a = P((e) => e.roles),
    o = P((e) => e.togglePlayerStatus),
    s = P((e) => e.undoAction),
    c = cr();
  if (e === null) return null;
  ...
  let u = l.roleId ? a.find((e) => e.id === l.roleId) : null,
    d = u?.abilities || [],
    f = c.get(e) || [],
    p = pr(u?.faction || `villager`);
  return (0, M.jsx)(_r, {
    isOpen: !0,
    onClose: t,
    title: l.name,
    icon: (0, M.jsx)(bn, { size: 20 }),
    children: (0, M.jsxs)(`div`, {
      className: `py-3`,
      children: [
        (0, M.jsxs)(`div`, {
          ...
          children: [
            (0, M.jsx)(`p`, {
              ...
              children: u ? Lr(r, u.nameKey, u.name) : r(`game.villager`),
            }),
            (0, M.jsx)(`p`, {
          ...
          (0, M.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, M.jsx)(`div`, {
                ...
                children: f.map((e) => {
                  let t = pr(e.faction),
                    n = Lr(r, e.abilityNameKey, e.abilityName),
                  ...
                  return (0, M.jsxs)(
                    `button`,
                    {
                      ...
                      children: [
                        e.abilityType === `limited` &&
                          (0, M.jsx)(sn, { size: 10, className: `opacity-70` }),
                        (0, M.jsx)(`span`, {
        ...
        (0, M.jsxs)(`button`, {
          ...
          children: [
            l.alive
              ? (0, M.jsx)(mn, { size: 18, className: `mr-2 inline` })
              : (0, M.jsx)(an, { size: 18, className: `mr-2 inline` }),
...
function Yr({ isOpen: e, onClose: t }) {
  let { t: n } = j(),
    r = P((e) => e.gameHistory),
    i = P((e) => e.actionLog),
    a = P((e) => e.statusChangeLog),
    o = P((e) => e.roleChangeLog),
    s = P((e) => e.players),
    c = P((e) => e.roles),
    l = P((e) => e.nightCount),
    u = P((e) => e.undoAction),
    ...
    g = (e) => {
      ...
      return t ? Lr(n, t.nameKey, t.name) : `?`;
    },
    v = (0, _.useMemo)(
      () =>
        [
                ...
                children: (0, M.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, M.jsx)(`span`, {
                      ...
                      children: (0, M.jsx)(qt, { size: 7 }),
                    }),
                    (0, M.jsx)(`span`, {
                      className: `font-black ${i.textBright}`,
                      children: Lr(n, r.abilityNameKey, r.abilityName),
                    }),
          ...
          `tr`,
          {
            ...
            children: [
              ...
              (0, M.jsxs)(`td`, {
                ...
                children: [
                  r.toStatus
                    ? (0, M.jsx)(an, { size: 10, className: `mr-2 inline` })
                    : (0, M.jsx)(mn, { size: 10, className: `mr-2 inline` }),
                  h(r.playerId),
                  ` —`,
                  ` `,
        ...
        `tr`,
        {
          ...
          children: [
            ...
            (0, M.jsxs)(`td`, {
              ...
              colSpan: t ? 1 : void 0,
              children: [
                (0, M.jsx)(Gt, { size: 10, className: `mr-2 inline` }),
                h(r.playerId),
                ` `,
                g(r.fromRoleId),
                ` → `,
        ...
        (0, M.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, M.jsxs)(`button`, {
              ...
              children: [
                (0, M.jsx)(ln, { size: 16, className: `mr-2 inline` }),
                n(`common.confirm`),
              ],
            }),
          ],
...
function Zr({ nightCount: e, onComplete: t }) {
  let { t: n } = j(),
    [r, i] = (0, _.useState)(!1);
  return (
    (0, _.useEffect)(() => {
...
function ei() {
  let { t: e } = j(),
    t = P((e) => e.nightCount),
    n = P((e) => e.timerSettings),
    r = P((e) => e.cardViewMode),
    i = P((e) => e.flippedCards),
    a = P((e) => e.flipCard),
    o = P((e) => e.undoAction),
    s = P((e) => e.redoAction),
    c = P((e) => e.actionLog),
    ...
    ne = (0, _.useCallback)(() => h(`assign`), []),
    re = (0, _.useCallback)(() => {
      (b(null), h(`skill`));
    }, []),
    ie = (0, _.useCallback)(() => v(null), []),
    ae = (0, _.useCallback)((e, t) => {
  ...
  let oe = (0, _.useCallback)(() => S(!1), []),
    se = (0, _.useRef)(t);
  return (
    (0, _.useEffect)(() => {
      (t > se.current && S(!0), (se.current = t));
    }, [t]),
    (0, M.jsxs)(`div`, {
        ...
        (0, M.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, M.jsx)(`button`, {
              ...
              children: (0, M.jsx)(wn, { size: 20 }),
            }),
          ],
        }),
        x && (0, M.jsx)(Zr, { nightCount: t, onComplete: oe }),
        m === `assign` && (0, M.jsx)(Gr, { isOpen: !0, onClose: w }),
        m === `skill` &&
          (0, M.jsx)(qr, { isOpen: !0, onClose: E, initialContext: y }),
        g !== null &&
          (0, M.jsx)(Jr, { playerId: g, onClose: ie, onUseSkill: ae }),
        m === `history` && (0, M.jsx)(Yr, { isOpen: !0, onClose: w }),
        m === `night` && (0, M.jsx)(Xr, { isOpen: !0, onClose: w }),
        m === `settings` && (0, M.jsx)(Cr, { isOpen: !0, onClose: w }),
      ],
    })
  );
}
  ...
  return (
    ...
    t
      ? (0, M.jsx)(_r, {
          ...
          icon: (0, M.jsx)(ln, { size: 20, className: `text-indigo-400` }),
...
((window.requestIdleCallback || ((e) => setTimeout(e, 1)))(() => jr()),
  Ar(
    (e) => (
      e(P.getState().timerSettings.muted),
      P.subscribe((t) => e(t.timerSettings.muted))
    ),
  ));
var fi = di({
  onNeedRefresh() {
...
((window.__updateSW = fi),
  (0, v.createRoot)(document.getElementById(`root`)).render(
    (0, M.jsx)(_.StrictMode, { children: (0, M.jsx)(ni, {}) }),
  ));
